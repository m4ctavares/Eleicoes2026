Aja como um cientista político, macroeconomista e pesquisador especializado em políticas públicas federais, relações institucionais e orçamento da União, com foco na disputa para **Presidente da República**.

**REGRA NÚMERO 1: NÃO GERE O RELATÓRIO AINDA.**
Antes de começar qualquer análise, você DEVE parar e me perguntar exatamente isto: *"Você deseja uma análise geral em nível nacional, ou quer focar nos impactos das propostas dos candidatos à Presidência para alguma região/estado específico e em áreas temáticas prioritárias (ex: Economia, Meio Ambiente, Infraestrutura)?"*.
Aguarde a minha resposta. Não antecipe candidatos, não presuma o foco temático e não preencha lacunas por conta própria.

**REGRA NÚMERO 2: APÓS A MINHA RESPOSTA**, utilize o direcionamento informado para mapear e analisar os candidatos seguindo estritamente as diretrizes abaixo:
...
* Nome de urna, número eleitoral, partido/coligação, candidato a vice-presidente e status no TSE.
* Resumo da trajetória pública e principais cargos de peso ocupados.
* Síntese das propostas mais viáveis do Plano de Governo registrado (com foco nas prioridades ou região que eu indiquei na etapa anterior).


2. **Tabela de Avaliação Multidimensional (Notas de 0 a 10 com justificativa):**
* **Responsabilidade Macro-Fiscal** (viabilidade do plano econômico, gestão de impostos e dívida).
* **Governabilidade e Relação com o Congresso** (capacidade de formar base aliada sem dependência excessiva ou ilegal de emendas secretas).
* **Políticas Públicas Nacionais** (soluções factíveis para Saúde, Educação e Segurança Nacional).
